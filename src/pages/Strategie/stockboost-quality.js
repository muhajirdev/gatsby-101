...
export default ({ classes = styles }) => (
  ...
  >
    <Typography
      ...
      variant="subtitle1"
    >
      In StockBoost ESA stellen wir aus den Erkenntnissen der akademischen Literatur
      ...
      <span>
        <br />
        <h3> StockBoost ESA – Struktur & Zielsetzung</h3>
        <br />
        <p>
          Im Informationsdienst StockBoost ESAsoll die Entwicklung eines aktiv
        ...
        <p>
          ...
          Umsetzung von StockBoost ESA werden permanent umfangreiche Auswertungen
          von Analystenprognosen über den gesamten US-Markt erstellt. Durch ein
          Ranglistensystem werden die Aktien für StockBoost ESA selektiert.
        </p>
        ...
        <p>
          ...
          Börsenphasen sind für StockBoost ESA Indexstände über dem Gleitenden
    ...
    <Collapsable title={"Erkenntnisse"}>
      ...
      <p>
        StockBoost ESA ist ein Informationsdienst von StockBoost.de und besteht aus
        ...
        Marktumfeld, zwischen 66,7 und 100 Prozent. StockBoost ESA wird als
      ...
      <ul style={{ listStyleType: "disc" }}>
        ...
        <li>
          ...
          StockBoost ESA auf Sektordiversifikation und Diversifikation hinsichtlich
