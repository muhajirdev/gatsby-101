...
export default withStyles(styles)(({ classes = styles }) => (
  ...
  >
    ...
    >
      ...
      <br />
      Wir handeln selbst seit vielen Jahren an der Börse und wollen nicht die
      Unwissenheit anderer ausnutzen, um uns selbst zu bereichern. Das geht nur
      über Transparenz und Offenheit.
      <br />
      Mit StockBoost haben wir ein Projekt gestartet, das diese Anforderungen
      umsetzt.
      <br />
      Mit systematischen Regeln setzen wir transparent in unserem
      Echtgeld-Depot, unseren Investment-Ansatz als Baustein für die
      Altersvorsorge in wenigen Minuten pro Woche um. <br />
    </Typography>

    <Collapsable
      title={"Details"}
      className={`${classes.link} ${classes.blocksatz}`}
    >
      <p>
        Wir wollen mit StockBoost einen umsetzbaren Investment-Ansatz auf
        transparenter Basis zeigen und das Thema finanzielle Bildung
        vorantreiben. Viele Andere sind mit solch einem Ansatz bisher
        gescheitert. Warum wir uns sprichwörtlich trotzdem auf so einen
      ...
      <h4>
        Warum ist StockBoost kostenpflichtig obwohl Ihr mit einem Echtgeldkonto
        an der Strategie partizipiert?
      </h4>
      <p>
        Die Angebote rund um das Thema Anlagemöglichkeiten sind in Deutschland,
        Österreich und der Schweiz aus unserer Sicht nicht optimal für die
        breite Masse ausgelegt. Das liegt einerseits an der vorliegenden
        Sparkultur und auch an der eher unzureichenden finanziellen Bildung. Wir
        wollen aber nicht nur „meckern“, sondern nachhaltig etwas verändern.
        <br />
        Wir haben StockBoost als nachvollziehbarer Informationsdienst konzipiert
        und werden aufzeigen, dass man mit geringen Kosten, wenig Zeitaufwand
        und einem angemessenen Risiko langfristig erfolgreich in Aktien
        investieren kann.
        <br />
